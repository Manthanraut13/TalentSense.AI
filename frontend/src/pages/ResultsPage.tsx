          ...
          <section className="mt-6 flex flex-wrap items-center gap-3 rounded-lg border border-line bg-surface p-5">
            ...
            {!shareUrl ? (
              <button
                ...
                disabled={isEnabling}
                className="flex items-center gap-2 rounded-lg border border-line px-4 py-2 text-sm text-textSecondary transition hover:border-primary hover:text-primary disabled:opacity-50"
              >
                <Share2 size={14} />
              ...
              <>
                <div className="flex min-w-0 flex-1 items-center gap-2 rounded-lg border border-primary/30 px-3 py-2">
                ...
                <button
                  ...
                  className="flex-shrink-0 text-xs text-textMuted transition hover:text-red-400"
                >
                  Stop sharing
                </button>
              </>
